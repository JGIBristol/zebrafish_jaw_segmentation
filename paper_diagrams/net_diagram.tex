...
\begin{tikzpicture}[node distance=2cm]
    ...
    \node (input) [block, below of=input_label, yshift=1cm]{1x160x160x160};

    % Contracting path
    \node (head) [block, below of=input, yshift=0.5cm] {8x160x160x160};

    \node (enc1) [block, below left of=head, yshift=-0.5cm, xshift=-1cm]{1x160x160x160};
    \node (conv1) [block, below of=enc1, yshift=0.5cm]{1x160x160x160};

    \node (enc2) [block, below left of=conv1, yshift=-0.5cm, xshift=-1cm]{1x160x160x160};
    \node (conv2) [block, below of=enc2, yshift=0.5cm]{1x160x160x160};

    \node (enc3) [block, below left of=conv2, yshift=-0.5cm, xshift=-1cm]{1x160x160x160};
    \node (conv3) [block, below of=enc3, yshift=0.5cm]{1x160x160x160};

    \node (enc4) [block, below left of=conv3, yshift=-0.5cm, xshift=-1cm]{1x160x160x160};
    \node (conv4) [block, below of=enc4, yshift=0.5cm]{1x160x160x160};

    \node (enc5) [block, below left of=conv4, yshift=-0.5cm, xshift=-1cm]{1x160x160x160};
    \node (conv5) [block, below of=enc5, yshift=0.5cm]{1x160x160x160};

    % Expanding Path
    \node (dec5) [block, below right of=conv5, yshift=-0.5cm, xshift=1cm]{1x160x160x160};
    \node (conv6) [block, below of=dec5, yshift=0.5cm] {1x};

    \node (dec4) [block, below right of=conv6, yshift=-0.5cm, xshift=1cm]{1x160x160x160};
    \node (conv7) [block, below of=dec4, yshift=0.5cm] {1x};

    \node (dec3) [block, below right of=conv7, yshift=-0.5cm, xshift=1cm]{1x160x160x160};
    \node (conv8) [block, below of=dec3, yshift=0.5cm] {1x};

    \node (dec2) [block, below right of=conv8, yshift=-0.5cm, xshift=1cm]{1x160x160x160};
    \node (conv9) [block, below of=dec2, yshift=0.5cm] {1x};

    \node (dec1) [block, below right of=conv9, yshift=-0.5cm, xshift=1cm]{1x160x160x160};

    % Output
    \node (output) [block, below of=dec1, yshift=0.5cm] {1x160x160x160};
    \node (output_label) [block, below of=output, yshift=1cm]{Output};

    % % Attention Mechanisms
    \node (att5) [attention, above right of=conv5, xshift=-1.5cm, yshift=1.5cm] {Att};
