...
\begin{tikzpicture}[node distance=1.8cm and 0.5cm]
	...
	% Decoder
	\node (dec0) [block, right=17cm of enc0] {$128\times10^3$};
	\node (dec1) [block, right=13.5cm of enc1]   {$64\times20^3$};
	\node (dec2) [block, right=10cm of  enc2]   {$32\times40^3$};
	\node (dec3) [block, right=6.5cm of  enc3]   {$16\times80^3$};
	\node (dec4) [block, right=3cm of  enc4]   {$8\times160^3$};

	% Bottleneck
	\node (bottom) [block, below right=1cm and 0.5cm of enc4] {$256\times5^3$};

	% Attention Gates
	\node (att4) [attention, left=1cm of dec4] {$\sigma$};
	\node (att3) [attention, left=1cm of dec3] {$\sigma$};
	\node (att2) [attention, left=1cm of dec2] {$\sigma$};
	\node (att1) [attention, left=1cm of dec1] {$\sigma$};
	\node (att0) [attention, left=1cm of dec0] {$\sigma$};
	...
	% Legend
	\matrix[draw, below right=2cm and 2cm of dec2, align=left, column sep=0.5cm, row sep=0.3cm, font=\scriptsize] {
