...
\tikzstyle{concat} = [draw, dotted, minimum width=2cm, minimum height=1cm, text centered]
...
\begin{tikzpicture}[node distance=1.8cm and 0.5cm]
	...
	\node (enc0b) [block, below left=1.5cm and 1cm of enc0a] {$8\times80^3$};

	\node (enc1a) [block, right=1cm of enc0b] {$16\times80^3$};
	\node (enc1b) [block, below left=1.5cm and 1cm of enc1a] {$16\times40^3$};

	\node (enc2a) [block, right=1cm of enc1b] {$32\times40^3$};
	\node (enc2b) [block, below left=1.5cm and 1cm of enc2a] {$32\times20^3$};

	\node (enc3a) [block, right=1cm of enc2b] {$64\times20^3$};
	\node (enc3b) [block, below left=1.5cm and 1cm of enc3a] {$64\times10^3$};

	\node (enc4a) [block, right=1cm of enc3b] {$128\times10^3$};
	\node (enc4b) [block, below=1.5cm of enc4a] {$128\times5^3$};

	% Bottleneck
	\node (bottom) [block, right=1cm of enc4b] {$128\times5^3$};

	% Attention Gates
	\node (att4) [attention, above=1.5cm of bottom] {$\sigma$};
