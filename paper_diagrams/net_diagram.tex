...
\begin{tikzpicture}[node distance=1.8cm and 0.5cm]
	...
	% Encoder
	\node (enc0a) [block, below=1cm of input_patch] {$8\times160^3$};
	\node (enc0b) [block, below=0.5cm of enc0a] {$16\times160^3$};

	\node (enc1a) [block, right=1cm of enc0b] {$16\times80^3$};
	\node (enc1b) [block, below=0.5cm of enc1a] {$32\times80^3$};

	\node (enc2a) [block, right=1cm of enc1b] {$32\times40^3$};
	\node (enc2b) [block, below=0.5cm of enc2a] {$64\times40^3$};

	\node (enc3a) [block, right=1cm of enc2b] {$64\times20^3$};
	\node (enc3b) [block, below=0.5cm of enc3a] {$128\times20^3$};

	\node (enc4a) [block, right=1cm of enc3b] {$128\times10^3$};
	\node (enc4b) [block, below=0.5cm of enc4a] {$256\times10^3$};

	% Decoder - skips
	\node (dec0skip) [concat, right=28.5cm of enc0b] {$8\times160^3$};
	\node (dec1skip) [concat, right=22.5cm of enc1b]   {$16\times80^3$};
	\node (dec2skip) [concat, right=16.5cm of enc2b]   {$32\times40^3$};
	\node (dec3skip) [concat, right=10.5cm of enc3b]   {$64\times20^3$};
	\node (dec4skip) [concat, right=4.5cm of  enc4b]   {$128\times10^3$};
	...
	% Bottleneck
	\node (bottom) [block, below right=1cm and 2.5cm of enc4b] {$256\times5^3$};
