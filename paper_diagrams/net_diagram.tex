...
\begin{tikzpicture}[node distance=2cm]
    ...
    \node (conv5) [block, below of=enc5, yshift=0.5cm]{$256\times5\times5\times5$};

    % Bottom layer

    % Expanding Path
    \node (dec5) [block, below right of=conv5, yshift=-0.5cm, xshift=1cm]{$256\times10\times10\times10$};
    \node (conv6) [block, below of=dec5, yshift=0.5cm] {$128\times10\times10\times10$};

    \node (dec4) [block, below right of=conv6, yshift=-0.5cm, xshift=1cm]{$128\times20\times20\times20$};
    \node (conv7) [block, below of=dec4, yshift=0.5cm] {$64\times20\times20\times20$};

    \node (dec3) [block, below right of=conv7, yshift=-0.5cm, xshift=1cm]{$64\times40\times40\times40$};
    \node (conv8) [block, below of=dec3, yshift=0.5cm] {$32\times40\times40\times40$};

    \node (dec2) [block, below right of=conv8, yshift=-0.5cm, xshift=1cm]{$32\times80\times80\times80$};
    \node (conv9) [block, below of=dec2, yshift=0.5cm] {$16\times80\times80\times80$};

    \node (dec1) [block, below right of=conv9, yshift=-0.5cm, xshift=1cm]{$16\times160\times160\times160$};

    % Output
    \node (output) [block, below of=dec1, yshift=0.5cm] {};
