...
\begin{tikzpicture}[node distance=2cm]
    ...
    % Contracting path
    \node (head) [block, right of=input, xshift=4cm] {$8\times160\times160\times160$};

    \node (enc1) [block, below right of=head, yshift=-0.5cm, xshift=0.5cm]{$8\times80\times80\times80$};
    \node (enc2) [block, below right of=enc1, yshift=-0.5cm, xshift=0.5cm]{$16\times40\times40\times40$};
    \node (enc3) [block, below right of=enc2, yshift=-0.5cm, xshift=0.5cm]{$32\times20\times20\times20$};
    \node (enc4) [block, below right of=enc3, yshift=-0.5cm, xshift=0.5cm]{$64\times10\times10\times10$};
    \node (enc5) [block, below right of=enc4, yshift=-0.5cm, xshift=0.5cm]{$128\times5\times5\times5$};

    % Bottom layer
    \node (bottom) [block, below right of=enc5, yshift=-0.5cm, xshift=1cm]{$256\times5\times5\times5$};

    % Expanding Path
    \node (dec5) [block, above right of=bottom, yshift=0.5cm, xshift=0.5cm]{$128\times10\times10\times10$};
    \node (dec4) [block, above right of=dec5, yshift=0.5cm, xshift=0.5cm]{$64\times20\times20\times20$};
    \node (dec3) [block, above right of=dec4, yshift=0.5cm, xshift=0.5cm]{$32\times40\times40\times40$};
    \node (dec2) [block, above right of=dec3, yshift=0.5cm, xshift=0.5cm]{$16\times80\times80\times80$};
    \node (dec1) [block, above right of=dec2, yshift=0.5cm, xshift=0.5cm]{$16\times80\times80\times80$};

    % % Output
    % \node (output) [block, below of=dec1, yshift=0.5cm] {$1\times160\times160\times160$};
