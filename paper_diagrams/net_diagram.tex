...
\begin{tikzpicture}[node distance=1.8cm and 0.5cm]
    ...
    \node (enc1b) [block, right=0.5cm of enc1] {$32\times160^3$};
    \node (enc2b) [block, right=0.5cm of enc2] {$64\times160^3$};
    \node (enc3b) [block, right=0.5cm of enc3] {$128\times160^3$};
    \node (enc4b) [block, right=0.5cm of enc4] {$256\times160^3$};

	% Decoder - skips
	\node (dec0) [concat, right=17cm of enc0] {$128\times10^3$};
	\node (dec1) [concat, right=14cm of enc1]   {$64\times20^3$};
	\node (dec2) [concat, right=11cm of  enc2]   {$32\times40^3$};
	\node (dec3) [concat, right=8cm of  enc3]   {$16\times80^3$};
	\node (dec4) [concat, right=4.5cm of  enc4]   {$8\times160^3$};
	...
	% Legend
	\matrix[draw, right=4cm of dec2, column sep=0.4cm, row sep=0.3cm, font=\scriptsize] {
